...
b1 = [0.0 0.0 100.0]
ssp1 = [
    0.000 1500.0 0.000 1.030 0.000 0.000
    100.0 1500.0 0.000 1.030 0.000 0.000
]

b2 = [0.000 0.000 120.0]
ssp2 = [
    100.0 1600.0 0.0 1.6 0.010 0.000
    120.0 1600.0 0.0 1.6 0.010 0.000
]
bsig = 0.0
clh = [0.0 1600.0]
rng = 5000000.0
...
sspBHS = [120.0 1800.0 0.0 2.0 0.05 0.0]
sspHS = [sspTHS; sspBHS]
...
f3 = Figure()
ax1 = Axis(f3[1, 1]; ylabel="Frequency (Hz)", xlabel="Wavenumber - real part", xticklabelrotation=pi/4)
for i in 1:nm
    lines!(ax1, kr_real[i, :], frq)
end

ax2 = Axis(f3[1, 2]; xlabel="Wavenumber - imaginary part", xticklabelrotation=pi/4)
for i in 1:nm
