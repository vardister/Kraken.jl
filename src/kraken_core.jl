...
"""
function det_sturm(kr, env::UnderwaterEnv, props::AcousticProblemProperties, cache::AcousticProblemCache;
...
"""
    inverse_iteration(kr, env::UnderwaterEnv, props::AcousticProblemProperties,
    cache::AcousticProblemCache; tol = 0.1, verbose = false)

Inverse iteration method to find the modes of the acoustic problem.
"""
